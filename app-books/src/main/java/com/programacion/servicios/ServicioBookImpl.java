...
public class ServicioBookImpl implements ServicioBook {
    ...
    @Override
    public void insertar(Book book) throws ExecutionException, InterruptedException {
    ...
    @Override
    public void modificar(int id, Book book) throws ExecutionException, InterruptedException {
        dbClient.execute(exec -> exec
                        .update("UPDATE books\n" +
